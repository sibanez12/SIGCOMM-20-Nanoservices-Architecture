...
\steve{Please review introduction: I made a few changes to the beginning to try and emphasize the potential benefits of increased parallelism, which is limited by modern infrastructure (hence the need for new infrastructure). Original intro is included in comments below.}
